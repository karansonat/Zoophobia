...
public class DigArea2 : MonoBehaviour, IActionObject, IUsableObject {    
    ...
    public void MakeAction(){
        ...
        if(_isRoadDigged){
           ...
           _flow.getActiveCharacterObject().GetComponent<Animator>().SetTrigger("Dig");
        }
    }
    ...
    private void setRoad(){
        ExitArea.GetComponent<DigArea>()._isRoadDigged = true;
        ExitArea.GetComponent<DigArea>().infoText = infoText;
